...
INSERT INTO `blockbuster_log` VALUES (1,'Review','2023-06-09 00:00:00','New review by client 1 for movie 1'),(2,'Review','2023-06-09 00:00:00','New review by client 1 for movie 1'),(3,'Review','2023-06-09 00:00:00','Deleted review of client 1 for movie 1'),(4,'rental','2023-06-09 00:00:00','New rental for client 1 and movie 1'),(5,'rental','2023-06-09 00:00:00','New rental for client 1 and movie 1'),(6,'rental','2023-06-09 00:00:00','New rental for client 1 and movie 1'),(7,'rental','2023-06-09 00:00:00','New rental for client 1 and movie 1'),(8,'rental','2023-06-09 00:00:00','Rental 1 updated');
...
INSERT INTO `category` VALUES (1,'ACTION','MOVIES INCLUDING WARLIKE CONFLICTS'),(4,'Romance','besos'),(5,'sci-fi','weas lokas');
...
INSERT INTO `client` VALUES (1,'MARTÍN','FLORES','cflores@itcr.ac.cr','12345678'),(3,'Matrix','1998-01-01','1','15');
...
INSERT INTO `movie` VALUES (1,'ROBOCOP','2014-12-11 00:00:00',1,5),(2,'Matrix2','1918-01-02 00:00:00',1,31),(3,'Matrix33','1918-01-02 00:00:00',1,31),(5,'Matrix44','1918-01-02 00:00:00',1,31);
...
CREATE TABLE `rental` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_rental_client_idx` (`client_id`),
  KEY `fk_rental_movie_idx` (`movie_id`),
  CONSTRAINT `rental_ibfk_1` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`),
  CONSTRAINT `rental_ibfk_2` FOREIGN KEY (`client_id`) REFERENCES `client` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rental` VALUES (1,'1999-01-01 00:00:00',1,1),(2,'1990-10-10 00:00:00',1,1),(3,'1991-10-10 00:00:00',1,1),(4,'1992-10-10 00:00:00',1,1),(5,'1993-10-10 00:00:00',1,1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `rental_AFTER_INSERT` AFTER INSERT ON `rental` FOR EACH ROW BEGIN INSERT INTO blockbuster_log (table_name,created_on,entry_text) VALUES('rental',current_date(),concat('New rental for client ',NEW.client_id,' and movie ',NEW.movie_id)); 
	END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `rental_AFTER_UPDATE` AFTER UPDATE ON `rental` FOR EACH ROW BEGIN INSERT INTO blockbuster_log (table_name,created_on,entry_text) VALUES('rental',current_date(),concat('Rental ',NEW.id,' updated')); 
	END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `rental_AFTER_DELETE` AFTER DELETE ON `rental` FOR EACH ROW BEGIN INSERT INTO blockbuster_log (table_name,created_on,entry_text) VALUES('rental',current_date(),concat('Deleted rental for client ',OLD.client_id,' and movie ',OLD.movie_id)); 
	END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `review` VALUES (1,1,1,4,'da susto','2023-05-11 00:00:00');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `review_AFTER_INSERT` AFTER INSERT ON `review` FOR EACH ROW BEGIN INSERT INTO blockbuster_log (table_name,created_on,entry_text) VALUE('Review',current_date(),concat('New review by client ',NEW.client_id,' for movie ',NEW.movie_id)); 
	END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `reviews_AFTER_UPDATE` AFTER UPDATE ON `review` FOR EACH ROW BEGIN INSERT INTO blockbuster_log (table_name,created_on,entry_text) VALUES('Review',current_date(),concat('Review ',NEW.id,' updated')); 
	END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `review_AFTER_DELETE` AFTER DELETE ON `review` FOR EACH ROW BEGIN INSERT INTO blockbuster_log (table_name,created_on,entry_text) VALUE('Review',current_date(),concat('Deleted review of client ',OLD.client_id,' for movie ',OLD.movie_id)); 
	END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	IF EXISTS(SELECT id FROM client WHERE id = p_client_id)
		THEN IF EXISTS(SELECT id FROM movie WHERE id = p_movie_id)
			THEN INSERT INTO rental(movie_id,client_id,rental_date) VALUES(p_movie_id,p_client_id,p_rental_date);
...
BEGIN
	...
	IF EXISTS(SELECT id FROM client WHERE id = p_client_id)
		THEN IF EXISTS(SELECT id FROM movie WHERE id = p_movie_id)
			THEN INSERT INTO review (movie_id,client_id,rating,review_text,created_on) VALUES (p_movie_id,p_client_id,p_rating,p_review_text,p_created_on);
...
BEGIN
	...
	IF NOT EXISTS(SELECT category_id FROM movie WHERE category_id = p_id)
...
BEGIN
	IF EXISTS(SELECT id FROM client WHERE id = p_id)
		THEN IF NOT EXISTS (SELECT client_id FROM rental WHERE client_id = p_id)
			THEN IF NOT EXISTS(SELECT client_id FROM review WHERE client_id = p_id)
				THEN DELETE FROM client WHERE id = p_id;
					SELECT 1 INTO procedure_completed;
			ELSE
				SET procedure_completed=1;
			END IF;
...
BEGIN
	...
	IF NOT EXISTS(SELECT movie_id FROM rental WHERE movie_id = p_id) THEN
...
BEGIN
	...
	IF EXISTS(SELECT id FROM rental WHERE id = p_id)
			THEN DELETE FROM rental WHERE id = p_id;
			SELECT 1 INTO procedure_completed;
	ELSE
		SET procedure_completed =-1;
	END IF;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `read_all_category` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `read_all_category`(
			)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `read_all_client` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `read_all_client`()
BEGIN
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		...
		END;
		START TRANSACTION;
			SELECT id, name, lastname, email, phone_number FROM client ORDER BY id ASC;
		COMMIT;
	END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `read_all_log` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `read_all_log`()
BEGIN
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			ROLLBACK;
		...
		END;
		START TRANSACTION;
			SELECT id, table_name, created_on, entry_text FROM blockbuster_log ORDER BY id ASC;
		COMMIT;
	END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `read_all_rental` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `read_all_rental`(
		)
BEGIN
			DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
			...
			END;
			START TRANSACTION;
				SELECT id, rental_date, client_id, movie_id FROM rental ORDER BY id ASC;
			COMMIT;
		END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `read_all_review` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `read_all_review`()
BEGIN
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			ROLLBACK;
...
BEGIN
	...
	IF EXISTS (SELECT id FROM client WHERE id = p_id)
		THEN SELECT * FROM client WHERE id = p_id;
        SELECT 1 INTO p_procedure_status;
	ELSE
		SET p_procedure_status =-1;
	END IF;
...
BEGIN
	...
	IF EXISTS(SELECT id FROM rental WHERE id = p_id)
		THEN SELECT * FROM rental WHERE id=p_id;
        SELECT 1 INTO p_procedure_status;
	ELSE
		SET p_procedure_status =-1;
	END IF;
...
BEGIN
	...
	IF EXISTS(SELECT id FROM review WHERE id = p_id)
		THEN SELECT * FROM review WHERE id=p_id;
        SELECT 1 INTO p_procedure_status;
	ELSE
		SET p_procedure_status =-1;
	END IF;
	...
	IF EXISTS(SELECT id FROM rental WHERE id = p_id)
		THEN IF EXISTS(SELECT id FROM movie WHERE id=p_movie_id)
			THEN IF EXISTS(SELECT id FROM client WHERE id=p_client_id) THEN
				UPDATE rental SET rental_date = p_rental_date, client_id= p_client_id, movie_id = p_movie_id WHERE id = p_id;
				SELECT 1 INTO p_procedure_status;
            ELSE
				SET p_procedure_status =-1;
		END IF;
	...
	IF EXISTS(SELECT id FROM review WHERE id = p_id)
		THEN IF EXISTS(SELECT id FROM movie WHERE id=p_movie_id)
			THEN IF EXISTS(SELECT id FROM client WHERE id=p_client_id)
				THEN UPDATE review SET movie_id = p_movie_id, client_id= p_client_id, rating = p_rating,review_text = p_review_text, created_on = p_created_on WHERE id = p_id;
				SELECT 1 INTO p_procedure_status;
            ELSE
				SET p_procedure_status =-1;
			END IF;
...
-- Dump completed on 2023-06-09 23:53:53
